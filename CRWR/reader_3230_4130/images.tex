...
{\newpage\clearpage
\lthtmlfigureA{framed20}%
\begin{framed}
  \begin{description}
  \item[Note]For complete course details, please visit the Moodle websites for Creative Writing 3230 and 4130. This guide is an adjunct to the core course materials.
  \end{description}
\end{framed}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}
